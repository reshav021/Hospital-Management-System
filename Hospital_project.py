#Create all file in pycharm
# 1.Hospital_project.py
# 2.Read_Hospital_Details.py
# 3.Write_Hospital_Details.py

#To store all details of doctor and patient
# 4.Doctors_Database.csv
# 5.Patients_Database.csv

import Read_Hospital_Details
import Write_Hospital_Details
...
while tries_flag != "Close the program" :
    ...
    Pateints_DataBase = Read_Hospital_Details.Read_Patients_DataBase()
    Doctors_DataBase  = Read_Hospital_Details.Read_Doctors_DataBase()
    ...
    if Admin_user_mode == "1" :                                                          #Admin mode
        ...
        while True :
                ...
                if AdminOptions == "1":                                             #Admin mode --> Pateints Management
                    ...
                    if Admin_choice == "1":                                    #Admin mode --> Appointment Management --> Book an appointment
                        try :     #To avoid non integer input
                            ...
                            print("---------------------------------------------------------")
                            print("|To book an appointment for an existing patient Enter 1   |\n|To book an appointment for a new patient Enter 2      |\n|To be Back Enter B                                     |")
                            print("---------------------------------------------------------")
                            Admin_choice = input("Enter your choice : ")
                            Admin_choice = Admin_choice.upper()
                            ...
                            while Session_Start[ :2] == "8":
                                Session_Start = input("Appointments should be between 08:00AM to 09:00PM, Please enter a time between working hours : ")

                            for i in Doctors_DataBase[Doctor_ID]:
                                if type(i[0])!=str:
                                    while Session_Start >= i[1] :
            ...
            Write_Hospital_Details.Write_Patients_DataBase(Pateints_DataBase)
            Write_Hospital_Details.Write_Doctors_DataBase(Doctors_DataBase)
        ...
        while True:
            ...
            print("|To view patient's residents Enter 3    |")
